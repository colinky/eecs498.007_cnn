...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        pre_embed = self.pretrained_embeddings(t)
        pre_embed_size = pre_embed.size()
        x = pre_embed.view(pre_embed_size[0], pre_embed_size[1] * pre_embed_size[2])
    ...
    def forward(self, t):
        ...
        m = F.relu(self.embed_to_hidden(self.embedding_lookup(t)))
        logits = self.hidden_to_logits(self.dropout(m))
